              ...
              <Table.Root color='white' size='lg' minW="70vw" maxW='90vw' minH='40vh' textStyle={'xl'} >
                <Table.Header color='white' textStyle={'2xl'}>
                  <Table.Row color='white' bg='rgb(31, 35, 62)'>
                    <Table.ColumnHeader color='white' textAlign="right" width='10%' px='5px'>Heat 1</Table.ColumnHeader>
                    ...
                    <Table.ColumnHeader color='white' textAlign="center" width='25%'>Resultat Heat 1</Table.ColumnHeader>
                  </Table.Row>
                </Table.Header>
                <Table.Body>
