...
const Heat2: React.FC<Heat2Props> = ({ data, category }) => {
  ...
  const sortedRacers = [...racerScores].sort((a, b) => (b.leaguePoints ?? 0) - (a.leaguePoints ?? 0));
            ...
            <Table.Root color='white' size="lg" minW="80vw" maxW="95vw" minH="40vh" textStyle="xl">
              <Table.Header color='white' textStyle="2xl">
                <Table.Row bg="rgb(31, 35, 62)" color="white">
                  <Table.ColumnHeader color='white' textAlign="right" width="8%" px="5px">Heat 2</Table.ColumnHeader>
                  ...
                  <Table.ColumnHeader color='white' textAlign="center" width="8%">Samlet</Table.ColumnHeader>
